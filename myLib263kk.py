...
class myCar(legoPart):
    ...
    def Turn3(self,turn=1,lane=1):
        ...
        while True:
            ...
            c.SetSonarAngle(angle=50*turn,speed=80)
            if c.fullDistance>marko:
                c.StopAllMotors()
                break
            if c.frontDistance<45 and abs(c.sonarAngle)+abs(c.angle-ang0)>85:
                lane2ob=True
                c.Beep()
        ...
        if lane2ob:
            ...
            while True:
                c.UpdateSendorDataLimited()
                c.SetSonarAngle(angle=-50,speed=80)
            ...
            while True:
                ...
                c.SetSonarAngle(angle=0,speed=80)
